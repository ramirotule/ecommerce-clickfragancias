  ...
  return (
    <section className="max-w-3xl mx-auto py-16 px-4">
      ...
      <div className="mb-8 space-y-2 text-lg">
        <div>
          <a href="https://wa.me/+542954000000" className="text-green-600 font-semibold hover:underline" target="_blank" rel="noopener">WhatsApp: +542954000000</a>
        </div>
        <div>
          <a href="tel:+542954000000" className="text-blue-700 font-semibold hover:underline">Teléfono: +542954000000</a>
        </div>
        <div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
        <a href="https://wa.me/+542954000000" target="_blank" rel="noopener" className="rounded-xl bg-green-500 text-white px-6 py-2 font-semibold hover:bg-green-700 transition">WhatsApp</a>
